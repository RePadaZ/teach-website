                ...
                <nav className="hidden lg:flex space-x-6 bg-gray-800 bg-opacity-80 px-6 py-3 rounded-full shadow-md">
                    {data.header.map((category) => (
                        <Menu as="div" className="relative inline-block text-left" key={category.id}>
                            <Menu.Button className="inline-flex items-center justify-center rounded-full px-5 py-2 text-sm font-medium text-white bg-gray-700 hover:bg-gray-600 transition">
                                {category.name}
                            ...
                            >
                                <Menu.Items className="absolute left-0 mt-3 w-56 bg-white bg-opacity-90 backdrop-blur-lg divide-y divide-gray-200 rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden z-50">
